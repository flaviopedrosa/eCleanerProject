<template>
    <q-page class="q-pa-lg">
        ...
        <div class="row items-center q-mb-xl">
            <div class="col">
                <div class="row items-center q-mb-sm">
                    ...
                    <q-icon :name="isEditMode ? 'edit' : 'construction'" size="2rem" class="text-secondary q-mr-md" />
                    <h4 class="text-h5 q-ma-none text-secondary">
                        {{ isEditMode ? $t('forms.equipamento.editTitle') : $t('forms.equipamento.newTitle') }}
                    </h4>
                </div>
                <div class="accent-divider q-mb-md"></div>
                <div class="row justify-end">
                    <p class="text-subtitle1 text-grey-7 q-ma-none">
                        {{ $t('forms.equipamento.formSubtitle') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <q-form @submit.prevent="salvarEquipamento" class="q-gutter-md">
                    ...
                    <q-card flat bordered>
                        <q-card-section>
                            <div class="text-h6 text-primary q-mb-md">
                                ...
                                {{ $t('forms.equipamento.sections.equipmentData') }}
                            </div>

                            <div class="row q-col-gutter-md">
                                <div class="col-12">
                                    <q-input v-model="form.Descricao"
                                        :label="$t('forms.equipamento.fields.descricao') + ' *'" filled lazy-rules
                                        :rules="[val => !!val || $t('forms.validation.required')]" />
                                </div>

                                <div class="col-12 col-md-6">
                                    <q-input v-model="valorFormatado"
                                        :label="$t('forms.equipamento.fields.precoUnitario') + ' *'" filled lazy-rules
                                        :rules="[val => !!val || $t('forms.validation.required')]" @input="onValorInput"
                                ...
                                <div class="col-12 col-md-6">
                                    <q-input v-model="form.Unidade"
                                        :label="$t('forms.equipamento.fields.unidade') + ' *'" filled lazy-rules
                                        :rules="[val => !!val || $t('forms.validation.required')]"
                    ...
                    <q-card flat bordered>
                        <q-card-section>
                            <div class="text-h6 text-primary q-mb-md">
                                ...
                                {{ $t('forms.equipamento.sections.imagePreview') }}
                            </div>

                            <q-card flat bordered class="cursor-pointer" @click="abrirSeletorImagem">
                                <!-- Imagem selecionada -->
                                <div v-if="imagemPreview">
                                    <q-img :src="imagemPreview" fit="contain" style="height: 340px;"
                                    ...
                                    <q-card-actions align="right">
                                        <q-btn flat color="negative" icon="delete" label="Remover"
                                ...
                                <div v-else class="flex flex-center q-pa-lg"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-grey-6 q-mt-sm">{{
                                            $t('forms.equipamento.messages.clickToSelectImage') }}</div>
                                    </div>
                                </div>
                            </q-card>
                        </q-card-section>
            ...
            <div class="row q-gutter-md justify-end">
                ...
                <q-btn color="primary" :label="isEditMode ? $t('buttons.update') : $t('forms.buttons.save')"
            ...
            try {
                ...
                $q.notify({
                    ...
                    message: isEditMode.value
                        ? t('forms.equipamento.messages.updateError')
                        : t('forms.equipamento.messages.saveError')
                })
            } finally {
                loading.value = false
            }
