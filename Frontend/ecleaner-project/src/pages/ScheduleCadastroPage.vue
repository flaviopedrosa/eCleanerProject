  ...
  <q-page class="q-pa-lg">
    ...
    <div class="row items-center q-mb-xl">
      <div class="col">
        <div class="col-12 col-md-1">
          <q-input v-model="form.enderecoComercial.estado" :label="$t('forms.schedule.fields.endereco.estado') + ' *'"
            :rules="[val => !!val || $t('forms.validation.required')]" filled lazy-rules />
        </div>iv class="row items-center q-mb-sm">
    ...
    <q-form @submit="handleSubmit" @reset="handleReset" class="q-gutter-md">
      <div class="row q-col-gutter-md">
        ...
        <div class="col-12 col-md-3">
          <q-input v-model="form.responsavel.telefone" :label="$t('forms.schedule.fields.responsavel.telefone')" filled
            lazy-rules mask="(##) ####-####" />
        </div>

        <div class="col-12 col-md-3">
          <q-input v-model="form.responsavel.celular" :label="$t('forms.schedule.fields.responsavel.celular') + ' *'"
            :rules="[val => !!val || $t('forms.validation.required')]" filled lazy-rules mask="(##) #####-####" />
        </div>

        <!-- Endereço Comercial -->
        <div class="col-12">
          <div class="text-subtitle1 text-primary q-mb-sm q-mt-lg">{{ $t('forms.schedule.sections.enderecoComercial') }}
          </div>
        </div>
        ...
        <div class="col-12 col-md-2">
          <q-input v-model="form.enderecoComercial.numero" :label="$t('forms.schedule.fields.endereco.numero') + ' *'"
            :rules="[val => !!val || $t('forms.validation.required')]" filled lazy-rules />
        </div>
        ...
        <div class="col-12 col-md-4">
          <q-input v-model="form.enderecoComercial.bairro" :label="$t('forms.schedule.fields.endereco.bairro') + ' *'"
            :rules="[val => !!val || $t('forms.validation.required')]" filled lazy-rules />
        </div>

        <div class="col-12 col-md-3">
          <q-input v-model="form.enderecoComercial.cidade" :label="$t('forms.schedule.fields.endereco.cidade') + ' *'"
            :rules="[val => !!val || $t('forms.validation.required')]" filled lazy-rules />
        </div>
        ...
        <div class="col-12 col-md-6">
          <q-input v-model="form.dadosBancarios.banco" :label="$t('forms.schedule.fields.dadosBancarios.banco') + ' *'"
        ...
        <div class="col-12 col-md-6">
          <q-input v-model="form.dadosBancarios.conta" :label="$t('forms.schedule.fields.dadosBancarios.conta') + ' *'"
