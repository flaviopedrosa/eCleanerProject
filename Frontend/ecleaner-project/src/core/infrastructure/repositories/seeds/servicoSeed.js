...
/**
 * Seed de serviços de limpeza
 * Cria 30 serviços diversos de limpeza doméstica, comercial e residencial
 */
export async function seedServicos() {
  const servicosData = [
    // Serviços Residenciais Básicos
    {
      ...
      descricao:
        'Limpeza geral de ambientes residenciais incluindo varredura, passagem de pano, limpeza de banheiros e organização básica.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza profunda de todos os cômodos da casa, incluindo limpeza de vidros, enceramento de pisos e limpeza detalhada.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza completa de apartamentos até 60m², incluindo todos os ambientes e organização.',
    },
    {
      ...
      descricao:
        'Limpeza especializada após reformas e obras, removendo entulho, poeira e resíduos de construção.',
    },
    {
    ...
    // Serviços Especializados Residenciais
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Lavagem profunda de carpetes, tapetes e estofados com equipamentos especializados e produtos específicos.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza completa de vidros internos e externos, janelas, espelhos e superfícies de vidro.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Aplicação de cera em pisos de madeira, laminado e vinílico para proteção e brilho.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza detalhada de cozinha incluindo fogão, forno, geladeira, armários internos e azulejos.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza profunda de banheiros com produtos específicos para remoção de calcário e fungos.',
    },
    ...
    // Serviços Comerciais
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza diária de escritórios até 100m², incluindo mesas, computadores, banheiros e copa.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza completa de escritórios acima de 200m², incluindo salas de reunião, recepção e áreas comuns.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza hospitalar de consultórios com produtos específicos e protocolo de desinfecção.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza especializada para clínicas odontológicas com desinfecção de equipamentos e ambientes.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza de estabelecimentos comerciais incluindo vitrine, provadores e área de atendimento.',
    },
    ...
    // Serviços Industriais e Especiais
    {
      ...
      descricao:
        'Limpeza pesada de galpões industriais, remoção de óleo, graxa e resíduos industriais.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza completa de restaurantes incluindo cozinha industrial, salão e área de preparo.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza e desinfecção de academias, vestiários, equipamentos e áreas de exercício.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza educacional com produtos atóxicos, desinfecção de brinquedos e mobiliário infantil.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza hospitalar com protocolos rígidos de desinfecção e produtos hospitalares.',
    },
    ...
    // Serviços Externos
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza externa de fachadas de prédios com equipamentos de segurança e produtos específicos.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Limpeza completa de piscinas incluindo aspiração, limpeza de bordas e tratamento da água.',
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza de áreas externas, varredura de folhas, limpeza de churrasqueira e mobiliário externo.',
    },
    {
    ...
    },
    {
      ...
      categoria: 'Residencial',
      descricao:
        'Limpeza completa após festas e eventos residenciais, incluindo jardim e área externa.',
    },
    {
      ...
      categoria: 'Especializado',
      descricao:
        'Organização completa de armários, guarda-roupas e despensas com sistema de categorização.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza especializada para apartamentos de temporada com troca de roupas de cama e organização.',
    },
    {
      ...
      categoria: 'Comercial',
      descricao:
        'Limpeza de áreas comuns de condomínios: hall, escadas, elevadores, salão de festas e portaria.',
    },
  ]

  // Cria instâncias da entidade Servico
  console.log('🔧 Criando', servicosData.length, 'instâncias de serviços...')
  const servicos = servicosData.map(
    (data) =>
      new Servico(data.nome, data.descricao, data.valor, data.valor, 'Unidade', data.categoria),
  )
