...
const useEquipamentoStore = defineStore("equipamento", {
  state: () => ({
    Equipamentos: [],
    Loading: false,
    Error: null
    ...
    async addEquipamento(equipamentoData) {
      ...
      try {
        const equipamento = new Equipamento(
          ...
          parseFloat(equipamentoData.PrecoUnitario) || 0,
  ...
  getters: {
    ...
    EquipamentosOrdenados: (state) => {
      return [...state.Equipamentos].sort(
...
export {
  useEquipamentoStore as u
};
//# sourceMappingURL=equipamento-store-CDIdSsiM.js.map
