import { _ as _export_sfc, a as defineComponent, c as createBlock, o as openBlock, w as withCtx, r as ref, M as onMounted, l as computed, x as watch, f as createBaseVNode, e as createVNode, Q as QIcon, t as toDisplayString, i as QBtn, j as createTextVNode, g as createElementBlock, a1 as Fragment, a2 as renderList, h as createCommentVNode, V as QAvatar, O as withDirectives } from "./index-DcwkHxen.js";
import { Q as QInput } from "./QInput-DXQxwL8P.js";
import { Q as QSelect, a as QDialog } from "./QSelect-DUStfZDN.js";
import { Q as QPage, a as QCard, b as QCardSection } from "./QPage-BYlIwfOX.js";
import { Q as QTable, a as QTd } from "./QTable-C_BNze_w.js";
import { Q as QTooltip } from "./QTooltip-Fc_weXo9.js";
...
import { Q as QPagination } from "./QPagination-Cc3XUNa6.js";
...
const _hoisted_16 = { class: "properties-cell" };
const _hoisted_17 = {
  key: 0,
  class: "text-grey-6"
};
...
const _hoisted_20 = { class: "lt-md" };
const _hoisted_21 = { class: "row q-col-gutter-md" };
const _hoisted_22 = { class: "row items-center q-mb-md" };
const _hoisted_23 = { class: "text-weight-medium" };
const _hoisted_24 = { class: "q-gutter-y-sm" };
const _hoisted_25 = { class: "row items-center" };
const _hoisted_26 = {
  key: 0,
  class: "row items-center"
};
const _hoisted_27 = { class: "row items-start" };
      ...
      createBaseVNode("div", _hoisted_12, [
        createVNode(QTable, {
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_13, [
                  createVNode(QAvatar, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.getInitials(props.row.Nome, props.row.Sobrenome)), 1)
                    ]),
                    _: 2
                  }, 1024),
                  createBaseVNode("div", _hoisted_14, toDisplayString(props.row.Nome) + " " + toDisplayString(props.row.Sobrenome), 1)
                ])
              ]),
              _: 2
            }, 1032, ["props"])
          ...
          "body-cell-enderecos": withCtx((props) => [
            createVNode(QTd, { props }, {
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_15, toDisplayString(props.row.Enderecos?.map((e) => _ctx.formatEndereco(e))?.join("\n") || "-"), 1)
              ]),
              _: 2
            }, 1032, ["props"])
          ]),
            ...
            createVNode(QTd, { props }, {
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_16, [
                  !props.row.Imoveis || props.row.Imoveis.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_17, toDisplayString(_ctx.$t("pages.clientList.noProperties")), 1)) : (openBlock(), createElementBlock("div", _hoisted_18, [
                          ...
                          createVNode(QTooltip, null, {
                            default: withCtx(() => [
                              createBaseVNode("div", null, [
                                ...
                                imovel.Observacao ? (openBlock(), createElementBlock("div", _hoisted_19, [
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_22, [
                        createVNode(QAvatar, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(_ctx.getInitials(cliente.Nome, cliente.Sobrenome)), 1)
                          ]),
                          _: 2
                        }, 1024),
                        createBaseVNode("div", _hoisted_23, toDisplayString(cliente.Nome) + " " + toDisplayString(cliente.Sobrenome), 1)
                      ]),
                      createBaseVNode("div", _hoisted_24, [
                        ...
                        cliente.Telefone || cliente.Celular ? (openBlock(), createElementBlock("div", _hoisted_26, [
                          createVNode(QIcon, {
                            name: "phone",
                            size: "sm",
                            color: "grey-7",
                        ...
                        cliente.Imoveis && cliente.Imoveis.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, [
                          createVNode(QIcon, {
                            name: "home",
                            size: "sm",
                            color: "grey-7",
                                  ...
                                  createVNode(QTooltip, null, {
                                    default: withCtx(() => [
                                      createBaseVNode("div", null, [
                                        ...
                                        createTextVNode(" " + toDisplayString(imovel.Endereco ? _ctx.formatEndereco(imovel.Endereco) : _ctx.$t("pages.clientList.noAddress")) + " ", 1),
                                        imovel.Observacao ? (openBlock(), createElementBlock("div", _hoisted_31, [
                                          createBaseVNode("strong", null, toDisplayString(_ctx.$t("pages.clientList.observations")) + ":", 1),
            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "row items-center" }, {
                default: withCtx(() => [
                  ...
                  createBaseVNode("span", _hoisted_33, toDisplayString(_ctx.$t("pages.clientList.deleteDialog.title")), 1)
                ]),
                _: 1
              }),
              createVNode(QCardSection, null, {
...
//# sourceMappingURL=ClienteListagemPage-DVmEY5UI.js.map
