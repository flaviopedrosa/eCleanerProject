...
class MaterialRepository {
  ...
  _mapToData(material) {
    return {
      ...
      PrecoUnitario: parseFloat(material.PrecoUnitario) || 0,
      // Garante que seja um número válido
  ...
  async searchByDescricao(termo) {
    try {
      ...
      return materiais.filter(
        (material) => material.Descricao.toLowerCase().includes(termo.toLowerCase())
      );
    } catch (error) {
...
export {
  MaterialRepository as M
};
//# sourceMappingURL=materialRepository-ClMwRjl3.js.map
